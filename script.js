...
#touch-options { top: 20px; right: 84px; } /* Modificado: ao lado do mode-button */
...
.camera-mode-button {
    display: none; /* Modificado: escondido por padrão */
    position: absolute;
    top: 20px;
    left: 50%;
...
.camera-mode-button.active { /* Modificado: só aparece com a classe active */
    display: flex;
}
